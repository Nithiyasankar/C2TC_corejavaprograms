package com.tnsif.dayfifteen.userdefined;
...
public class LambdaCollection {
	...
	public static void main(String[] args) {
		...
		Student s1 = new Student(11, "Nithiya", 78);
		studentList.add(s1);
		s1 = new Student(21, "Abinaya", 85);
		studentList.add(s1);
		s1 = new Student(13, "Albi Maria", 68);
		studentList.add(s1);
		s1 = new Student(41, "Dhivya", 72);
		studentList.add(s1);
